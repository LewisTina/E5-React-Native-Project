    ...
    try {
      ...
      if (status !== "granted") {
        showPermissionAlert(
          ...
          "Nous avons besoin de l'accès à vos photos pour sélectionner des images.",
        );
        return;
      }
    ...
    try {
      ...
      if (status !== "granted") {
        showPermissionAlert(
          ...
          "Nous avons besoin de l'accès à votre localisation pour obtenir votre position actuelle.",
        );
        return;
      }
